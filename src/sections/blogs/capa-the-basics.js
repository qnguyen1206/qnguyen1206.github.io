...
Since we know that the processing time takes several minutes, we have pre-processed this to a file named **cryptbot.txt** located in **C:\\Users\\Administrator\\Desktop\\capa**. Open another PowerShell terminal and use the command \`Get-Content cryptbot.txt\`
\`\`\`
...
**MBC Behaviors**
The column MBC Behaviors contains behaviours and Micro-behaviors with or without its methods and identifiers. Please check the link <a href="https://github.com/MBCProject/mbc-markdown/blob/main/mbc_summary.md">MBC Summary</a> for a listing of all MBC content.
...
<img src="/blogs/tryhackme/capa-the-basics/5e6bbe59a46ee9407fd65bbe-1728863959663.png">

In addition to what was mentioned in the above table, there are still a few more namespaces under **Anti-Analysis** with corresponding rules. If you want to dig deeper, please check this <a href="https://github.com/MBCProject/capa-rules-1/tree/master/anti-analysis">link</a>.

Use this <a href="https://github.com/MBCProject/capa-rules-1?tab=readme-ov-file#namespace-organization">link</a> if you are interested in the other TLN or Top-Level Namespaces, such as collection, compiler, persistence, linking, and impact.
...
reference anti-VM strings | Anti-Analysis | anti-vm/vm-detection | reference-anti-vm-strings.yml | To check all rules under this namespace, <a href="https://github.com/MBCProject/capa-rules-1/tree/master/anti-analysis/anti-vm/vm-detection">click here</a>
reference anti-VM strings targeting VMWare | Anti-Analysis | anti-vm/vm-detection | reference-anti-vm-strings-targeting-vmware.yml | To check all rules under this namespace, click <a href="https://github.com/MBCProject/capa-rules-1/tree/master/anti-analysis/anti-forensic">here</a>
...
reference HTTP User-Agent string | Communication | http/client | reference-http-user-agent-string.yml | To check all rules under this namespace, click <a href="https://github.com/MBCProject/capa-rules-1/tree/master/communication/http/client">here</a>
check HTTP status code | Communication | http | check-http-status-code.yml | To check all rules under this namespace, click <a href="https://github.com/MBCProject/capa-rules-1/tree/master/communication/http">here</a>
reference Base64 string | Data Manipulation | encoding/base64 | reference-base64-string.yml | To check all rules under this namespace, click <a href="https://github.com/MBCProject/capa-rules-1/tree/master/data-manipulation/encoding/base64">here</a>
encode data using XOR | Data Manipulation | encoding/XOR | encode-data-using-xor.yml | To check all rules under this namespace, click <a href="https://github.com/MBCProject/capa-rules-1/tree/master/data-manipulation/encoding/xor">here</a>
...
delete file	Host-Interaction | file-system/delete | delete-file.yml | To check all rules under this namespace, click <a href="https://github.com/MBCProject/capa-rules-1/tree/master/host-interaction/file-system/delete">here</a>
read file on Windows | Host-Interaction | file-system/read | read-file-on-windows.yml | To check all rules under this namespace, click <a href="https://github.com/MBCProject/capa-rules-1/tree/master/host-interaction/file-system/read">here</a>
write file on Windows | Host-Interaction | file-system/write | write-file-on-windows.yml | To check all rules under this namespace, click <a href="https://github.com/MBCProject/capa-rules-1/tree/master/host-interaction/file-system/write">here</a>
...
allocate or change RWX memory | Host-Interaction | process/inject | allocate-or-change-rwx-memory.yml | To check all rules under this namespace, click <a href="https://github.com/MBCProject/capa-rules-1/tree/master/host-interaction/process/inject">here</a>
create process on Windows | Host-Interaction | process create | create-process-on-windows.yml | To check all rules under this namespace, click <a href="https://github.com/MBCProject/capa-rules-1/tree/master/host-interaction/process/create">here</a>
...
link function at runtime on Windows | Linking | runtime-linking | link-function-at-runtime-on-windows.yml | To check all rules under this namespace, click <a href="https://github.com/MBCProject/capa-rules-1/tree/master/linking/runtime-linking">here</a>
parse PE header | load-code | load-code/pe | parse-pe-header.yml, resolve-function-by-parsing-pe-exports.yml | To check all rules under this namespace, <a href="https://github.com/MBCProject/capa-rules-1/tree/master/load-code/pe">click here</a>
resolve function by parsing PE exports	load-code	load-code/pe | resolve-function-by-parsing-pe-exports.yml | To check all rules under this namespace, <a href="https://github.com/MBCProject/capa-rules-1/tree/master/load-code/pe">click here</a>
run PowerShell expression	load-code	load-code/PowerShell | run-powershell-expression.yml | To check all rules under this namespace, <a href="https://github.com/MBCProject/capa-rules-1/tree/master/linking/runtime-linking">click here</a>
...
Check the conditions inside the \`check-for-windows-sandbox-via-registry.yml\` rule file from this <a href="https://github.com/MBCProject/capa-rules-1/blob/master/anti-analysis/anti-vm/vm-detection/check-for-windows-sandbox-via-registry.yml">link</a>. What is the **value of the API** that ends in \`Ex\` is it looking for?
**Answer:** RegOpenKeyEx
...
<img src="/blogs/tryhackme/capa-the-basics/5e6bbe59a46ee9407fd65bbe-1726486090871.png">
...
<img src="/blogs/tryhackme/capa-the-basics/5e6bbe59a46ee9407fd65bbe-1726487492872.png">
...
<img src="/blogs/tryhackme/capa-the-basics/5e6bbe59a46ee9407fd65bbe-1726488911179.png">
