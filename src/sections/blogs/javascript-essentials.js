export default {
    ...
    excerpt: 'Write up and walkthrough of JavaScript Essentials room on TryHackMe.',
    content: `
This is a write up and walkthrough of the JavaScript Essentials room on TryHackMe.
...
In web development, the request-response cycle is when a user's browser (the client) sends a request to a web server, and the server responds with the requested information. This could be a webpage, data, or other resources. You can learn more about it <a href="https://tryhackme.com/room/howwebsiteswork">here</a>.
...
<img src="/blogs/tryhackme/javascript-essentials/62a7685ca6e7ce005d3f3afe-1728735438271.png">
...
This task assumes you have a basic understanding of HTML and its structure. This section will explore how JS can be integrated into HTML. Usually, JS is not used to render content; it works with HTML and CSS to create dynamic and interactive web pages. If you're unfamiliar with HTML, reviewing it through the <a href="https://tryhackme.com/room/howwebsiteswork">provided link</a> is recommended. There are two main ways to integrate JS into HTML: internally and externally.
...
<img src="/blogs/tryhackme/javascript-essentials/62a7685ca6e7ce005d3f3afe-1728752465953.png">
...
<img src="/blogs/tryhackme/javascript-essentials/62a7685ca6e7ce005d3f3afe-1728803417509.png">
...
<img src="/blogs/tryhackme/javascript-essentials/62a7685ca6e7ce005d3f3afe-1728803945443.png">

**Answer the questions below**⸻⸻⸻⸻⸻

What is the message displayed if you enter the age less than 18?
**Answer:** You are a minor.
**Reason:** Right-click and select "View Page Source".
...
<img src="/blogs/tryhackme/javascript-essentials/62a7685ca6e7ce005d3f3afe-1728811321758.png">

**Obfuscation in Action**
Now, we will try to minify and obfuscate the JS code using an online tool. Visit the <a href="https://codebeautify.org/javascript-obfuscator">website</a> and copy the contents of \`hello.js\`, and paste them into the dialogue box on the website. The tool will minify and obfuscate the code, turning it into a string of gibberish characters shown below:
<img src="/blogs/tryhackme/javascript-essentials/62a7685ca6e7ce005d3f3afe-1728812285853.png">
