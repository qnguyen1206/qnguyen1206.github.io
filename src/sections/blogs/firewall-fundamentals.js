export default {
    ...
    excerpt: 'Write up and walkthrough of Firewall Fundamentals room on TryHackMe.',
    content: `
This is a write up and walkthrough of the Firewall Fundamentals room on TryHackMe.
...
<img src="/blogs/tryhackme/firewall-fundamentals/5f9c7574e201fe31dad228fc-1726665055716.png">
...
<img src="/blogs/tryhackme/firewall-fundamentals/6645aa8c024f7893371eb7ac-1726644402513.png">
...
**Answer:** Core Op
**Reason:** Find any rule that use Local Port "22" and action "Block" since 22 is the default port for SSH.

A rule was created to allow SSH from one single IP address. What is the rule name?
**Answer:** Infra team
**Reason:** Find any rule that use Local Port "22", action "Allow" and Remote Address is a single IP address.
