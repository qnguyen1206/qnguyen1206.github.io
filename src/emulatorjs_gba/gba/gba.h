...
//                       BUTTON INPUT
// ---------------------------------------------------------------------------
#define BUTTON_A        (1<<0)           //X
#define BUTTON_B        (1<<1)           //Z
#define BUTTON_SELECT   (1<<2)           //BACKSPACE
#define BUTTON_START    (1<<3)           //ENTER
#define BUTTON_RIGHT    (1<<4)           //ARROW KEYS
#define BUTTON_LEFT     (1<<5)           //ARROW KEYS
#define BUTTON_UP       (1<<6)           //ARROW KEYS
#define BUTTON_DOWN     (1<<7)           //ARROW KEYS
